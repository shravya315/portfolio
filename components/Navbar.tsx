    ...
    const signupButtonElement = (
        <div className="relative group w-full sm:w-auto">
            <Link href="#contact" className=''>
                ...
                <button className="relative z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-linear-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 w-full sm:w-auto hover:cursor-pointer">
                    Contact
                </button>
            </Link>
